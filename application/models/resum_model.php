<?php
	class Resum_model extends CI_Model 
	{
		...
		public function setResume($userid)
		{
			 ...
			 if($userid)
			{
				...
				$datas = array(
					...
					'Birth_of_Date' => $data['basicinfo']['born'],				
					'PoliticyState' => $data['basicinfo']['politicystate'],
					'Email' => $data['basicinfo']['email'],
					'Address' => $data['basicinfo']['address'],
					'eduin' => $data['basicinfo']['edu-in'],
					'eduout' => $data['basicinfo']['edu-out'],
					'School' => $data['basicinfo']['university'],				
					'Major' => $data['basicinfo']['major'],
					'eduxueli' => $data['basicinfo']['xueli'],
					);
